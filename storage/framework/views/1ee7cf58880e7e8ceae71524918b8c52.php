...
<?php $__env->startSection('title', config('app.name') . ' - تسوق أفضل المنتجات بأسعار مميزة'); ?>
<?php $__env->startSection('description', 'متجر إلكتروني متكامل - شحن مجاني - الدفع عند الاستلام - تشكيلة واسعة من المنتجات في 6 دول عربية'); ?>

<?php $__env->startSection('content'); ?>


<section class="relative overflow-hidden text-white <?php echo e(site('hero_image') ? '' : 'bg-gradient-to-bl from-brand-700 via-brand-600 to-brand-500'); ?>" <?php if(site('hero_image')): ?> style="background-image: url('<?php echo e(site('hero_image')); ?>'); background-size: cover; background-position: center;" <?php endif; ?>>
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div data-aos="fade-up">
                <span class="inline-flex items-center gap-2 bg-white/15 backdrop-blur-md px-4 py-1.5 rounded-full text-sm mb-6">
                    ...
                    <?php echo e(site('hero_badge', 'عروض حصرية تصل إلى 50%')); ?>

                </span>

                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-6 text-balance">
                    <?php echo e(site('hero_title', 'تسوق بذكاء ، عش تجربة فريدة')); ?>

                </h1>

                <p class="text-lg sm:text-xl mb-8 text-white/90 max-w-xl text-pretty">
                    <?php echo e(site('hero_subtitle', 'اكتشف أحدث المنتجات بأفضل الأسعار مع شحن مجاني فوق ' . config('ecommerce.shipping.free_threshold', 500) . ' ' . currentCurrencySymbol())); ?>

                </p>

                <div class="flex gap-3 flex-wrap mb-10">
                    <a href="<?php echo e(route('shop.index')); ?>" class="btn-accent btn-lg shadow-accent">
                        <span class="material-symbols-outlined">shopping_cart</span>
                        تسوق الآن
                    </a>
                    <a href="<?php echo e(route('shop.index')); ?>?featured=1" class="btn btn-lg bg-white/15 backdrop-blur-md border border-white/30 text-white hover:bg-white/25">
                ...
                <div class="relative">
                    ...
                    <div class="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl">
                        <div class="grid grid-cols-2 gap-4">
                            <?php $__empty_1 = true; $__currentLoopData = $featuredProducts->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="bg-white rounded-2xl p-3 shadow-soft hover:scale-105 transition-transform duration-300 <?php echo e($i % 2 == 0 ? 'rotate-[-3deg]' : 'rotate-[3deg]'); ?>">
                                    <div class="aspect-square bg-gray-100 rounded-xl mb-2 overflow-hidden">
                                        <?php if($p->primaryImage): ?>
                                            <img src="<?php echo e(asset('storage/' . $p->primaryImage->image)); ?>" alt="<?php echo e($p->name); ?>" class="w-full h-full object-cover">
                                        <?php else: ?>
                                    ...
                                    <p class="text-xs font-bold text-brand-600"><?php echo e(number_format($p->price, 0)); ?> <?php echo e(currentCurrencySymbol()); ?></p>
                                </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500">للطلبات فوق <?php echo e(config('ecommerce.shipping.free_threshold', 500)); ?></p>
                </div>
            </div>
            <div class="flex items-center gap-3">
...
<?php if($categories->count() > 0 && site('show_categories', '1') === '1'): ?>
<section class="section bg-gray-50">
    <div class="container-app">
        <div class="text-center mb-10">
            ...
            <p class="text-gray-500">اختر من بين <?php echo e($categories->count()); ?> تصنيف متوفر</p>
        </div>
                   ...
                   class="group relative bg-white rounded-2xl p-5 text-center transition-all duration-300 hover:-translate-y-1 border border-gray-100 hover:border-brand-200 overflow-hidden">
                    ...
                    <div class="relative z-10">
                        <div class="w-16 h-16 mx-auto mb-3 rounded-2xl bg-gradient-to-br from-brand-100 to-brand-50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                            <span class="material-symbols-outlined text-2xl text-brand-600"><?php echo e($category->icon ?? 'local_offer'); ?></span>
                        </div>
                        <h3 class="font-semibold text-sm text-gray-800 group-hover:text-brand-700 transition-colors"><?php echo e($category->name); ?></h3>
                        <p class="text-xs text-gray-400 mt-1"><?php echo e($category->products_count ?? $category->products()->count()); ?> منتج</p>
                    </div>
                </a>
...
<?php if($featuredProducts->count() > 0 && site('show_featured', '1') === '1'): ?>
<section class="section">
    <div class="container-app">
        <div class="flex items-end justify-between mb-8 flex-wrap gap-4">
            ...
            <a href="<?php echo e(route('shop.index')); ?>?featured=1" class="btn btn-secondary">
                عرض الكل
...
<?php if($latestProducts->count() > 0 && site('show_latest', '1') === '1'): ?>
            ...
            <div class="relative z-10 grid md:grid-cols-2 gap-8 items-center">
                <div>
                    ...
                    <h2 class="text-3xl md:text-4xl font-extrabold mb-3 text-balance">
                        <?php if(site('banner_1_title')): ?>
                            <?php echo e(site('banner_1_title')); ?>
                    ...
                    <p class="text-white/90 text-lg mb-6 text-pretty">
                        <?php echo e(site('banner_1_subtitle', 'توصيل سريع لكل المدن في 6 دول - تتبع شحنتك لحظة بلحظة')); ?>

                    </p>
                    <a href="<?php echo e(site('banner_1_link') ?: route('shop.index')); ?>" class="btn btn-lg bg-white text-accent-600 hover:bg-gray-100">
                        <span class="material-symbols-outlined">shopping_cart</span>
                        تسوق الآن
                    </a>
                </div>
                <div class="hidden md:flex justify-center">
                    <?php if(site('banner_1_image')): ?>
                        <img src="<?php echo e(site('banner_1_image')); ?>" alt="" class="rounded-2xl shadow-2xl max-w-md w-full object-cover">
                    <?php else: ?>
...
<?php if(site('banner_2_title') || site('banner_2_image')): ?>
<section class="section">
    <div class="container-app">
        <div class="relative overflow-hidden rounded-3xl bg-gradient-to-l from-purple-600 to-pink-500 text-white p-8 md:p-12">
            <div class="relative z-10 grid md:grid-cols-2 gap-8 items-center">
                <div>
                    <h2 class="text-3xl md:text-4xl font-extrabold mb-3"><?php echo e(site('banner_2_title')); ?></h2>
                    <p class="text-white/90 text-lg mb-6"><?php echo e(site('banner_2_subtitle')); ?></p>
                    <?php if(site('banner_2_link')): ?>
                        <a href="<?php echo e(site('banner_2_link')); ?>" class="btn btn-lg bg-white text-purple-600 hover:bg-gray-100">
                            <span class="material-symbols-outlined">arrow_back</span> اكتشف المزيد
                        </a>
                    <?php endif; ?>
                </div>
                <?php if(site('banner_2_image')): ?>
                    <div class="hidden md:flex justify-center">
                        <img src="<?php echo e(site('banner_2_image')); ?>" alt="" class="rounded-2xl shadow-2xl max-w-md w-full object-cover">
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\amarn\ecommerce\resources\views/frontend/home.blade.php ENDPATH**/ ?>
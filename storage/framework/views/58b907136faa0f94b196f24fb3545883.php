        ...
        <div class="flex items-center justify-between h-10 flex-wrap">
            <div class="flex items-center gap-4 flex-wrap">
                <span class="flex items-center gap-1.5">
                    ...
                    <span>شحن مجاني فوق <?php echo e(config('ecommerce.shipping.free_threshold', 500)); ?> <?php echo e(currentCurrencySymbol()); ?></span>
                </span>
            ...
            <div class="hidden md:flex items-center gap-4">
                ...
                <a href="<?php echo e(route('track')); ?>" class="hover:text-accent-200 transition">تتبع طلبك</a>
                <span class="text-white/30">|</span>
                <a href="<?php echo e(route('page.show', 'faq')); ?>" class="hover:text-accent-200 transition">المساعدة</a>
            </div>
        </div>
    </div>
</div>
...
<header class="bg-white/95 backdrop-blur-md sticky top-0 z-40 border-b border-gray-100"
    ...
    <div class="container-app">
        <div class="flex items-center justify-between h-16 lg:h-20 gap-4">
            ...
            <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 flex-shrink-0">
                <?php if(site('store_logo')): ?>
                    <img src="<?php echo e(site('store_logo')); ?>" alt="<?php echo e(site('store_name')); ?>" class="h-10 lg:h-12 w-auto object-contain">
                <?php else: ?>
                ...
                <div class="hidden sm:block">
                    <p class="font-extrabold text-lg lg:text-xl text-gray-900 leading-tight"><?php echo e(site('store_name', config('app.name'))); ?></p>
                    <p class="text-[10px] text-gray-500 leading-tight"><?php echo e(site('store_description', 'متجرك المفضل')); ?></p>
                </div>
            </a>

            
            <div class="hidden md:block flex-1 max-w-2xl relative"
                 x-data="liveSearch('<?php echo e(route('shop.index')); ?>', 2)"
                 @click.outside="close()">
            ...
            <div class="flex items-center gap-1 sm:gap-2 flex-shrink-0">
                ...
                <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                    <button @click="open = !open" type="button"
                        ...
                        <span class="text-xs font-semibold hidden lg:inline"><?php echo e(countryCurrency(session('selected_country', 'SD'))); ?></span>
                    ...
                    <div x-show="open" x-transition
                        ...
                        <?php $countries = config('ecommerce.countries', []); ?>
                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('currency.switch', $code)); ?>"
                               class="flex items-center gap-2 px-3 py-2 hover:bg-gray-50 text-sm <?php echo e(session('selected_country', 'SD') === $code ? 'bg-brand-50 text-brand-700 font-semibold' : 'text-gray-700'); ?>">
                                <span class="text-base font-bold w-8 text-center"><?php echo e($info['currency_symbol'] ?? ''); ?></span>
                                <span class="flex-1"><?php echo e($info['name'] ?? $code); ?></span>
                                <span class="text-xs text-gray-400"><?php echo e($code); ?></span>
                            </a>
                ...
                <a href="<?php echo e(route('wishlist.index')); ?>" class="btn-icon text-gray-600 hover:text-accent-500 relative hidden sm:inline-flex">
                ...
                <a href="<?php echo e(route('cart.index')); ?>" class="btn-icon text-gray-600 hover:text-brand-600 relative">
                    ...
                    <div class="relative" @click.outside="userMenu = false">
                        ...
                        <div x-show="userMenu"
                            ...
                            <div class="px-4 py-3 border-b border-gray-100">
                                <p class="font-semibold text-sm text-gray-800"><?php echo e(auth()->user()->name); ?></p>
                                <p class="text-xs text-gray-500 truncate"><?php echo e(auth()->user()->email); ?></p>
                            </div>
                            <div class="py-1">
                                <a href="<?php echo e(route('account.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-brand-50 hover:text-brand-700 transition">
                                    <span class="material-symbols-outlined w-4">person</span> حسابي
                                </a>
                                <a href="<?php echo e(route('orders.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-brand-50 hover:text-brand-700 transition">
                                    <span class="material-symbols-outlined w-4">inventory_2</span> طلباتي
                                </a>
                                <a href="<?php echo e(route('wishlist.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-brand-50 hover:text-brand-700 transition sm:hidden">
                                    <span class="material-symbols-outlined w-4">favorite</span> المفضلة
                                </a>
                                <?php if(auth()->user()->isAdmin() || auth()->user()->isManager()): ?>
                                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-brand-50 hover:text-brand-700 transition">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="hidden md:inline-flex btn btn-ghost btn-sm">
        ...
        <nav class="hidden md:flex items-center gap-1 py-2 border-t border-gray-100 text-sm overflow-x-auto no-scrollbar">
            ...
            <a href="<?php echo e(route('shop.index')); ?>" class="nav-link <?php echo e(request()->routeIs('shop.index') ? 'active' : ''); ?>">
                <span class="material-symbols-outlined ml-1.5">storefront</span> جميع المنتجات
            </a>
            <?php $__currentLoopData = ($navCategories ?? collect())->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('shop.category', $cat->slug)); ?>" class="nav-link <?php echo e(request()->is('category/'.$cat->slug) ? 'active' : ''); ?>">
                    <span class="material-symbols-outlined ml-1.5 text-xs opacity-70"><?php echo e($cat->icon ?? 'local_offer'); ?></span> <?php echo e($cat->name); ?>
    ...
    <div x-show="mobileMenu"
        ...
        <div class="container-app py-4 space-y-1">
            <a href="<?php echo e(route('home')); ?>" class="block px-4 py-3 rounded-xl text-gray-700 hover:bg-brand-50 hover:text-brand-700 font-medium">
                <span class="material-symbols-outlined ml-2 text-brand-500">home</span> الرئيسية
            </a>
            <a href="<?php echo e(route('shop.index')); ?>" class="block px-4 py-3 rounded-xl text-gray-700 hover:bg-brand-50 hover:text-brand-700 font-medium">
                <span class="material-symbols-outlined ml-2 text-brand-500">storefront</span> جميع المنتجات
            </a>
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('orders.index')); ?>" class="block px-4 py-3 rounded-xl text-gray-700 hover:bg-brand-50 hover:text-brand-700">
                    <span class="material-symbols-outlined ml-2 text-brand-500">inventory_2</span> طلباتي
                </a>
                <a href="<?php echo e(route('wishlist.index')); ?>" class="block px-4 py-3 rounded-xl text-gray-700 hover:bg-brand-50 hover:text-brand-700">
                    <span class="material-symbols-outlined ml-2 text-accent-500">favorite</span> المفضلة
                </a>
                <a href="<?php echo e(route('account.index')); ?>" class="block px-4 py-3 rounded-xl text-gray-700 hover:bg-brand-50 hover:text-brand-700">
                    <span class="material-symbols-outlined ml-2 text-brand-500">person</span> حسابي
                </a>
                <?php if(auth()->user()->isAdmin() || auth()->user()->isManager()): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-4 py-3 rounded-xl text-gray-700 hover:bg-brand-50 hover:text-brand-700">
                        <span class="material-symbols-outlined ml-2 text-brand-500">dashboard</span> لوحة التحكم
                    </a>
                <?php endif; ?>
                <form method="POST" action="<?php echo e(route('logout')); ?>" class="pt-2 border-t border-gray-100 mt-2">
                    <?php echo csrf_field(); ?>
            ...
            <?php else: ?>
                <div class="grid grid-cols-2 gap-2 pt-3 border-t border-gray-100 mt-2">
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-secondary">دخول</a>
                    <a href="<?php echo e(route('register')); ?>" class="btn-primary">تسجيل</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\amarn\ecommerce\resources\views/frontend/partials/header.blade.php ENDPATH**/ ?>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div class="bg-gray-50 rounded-lg p-3 text-center">
                        ...
                        <div class="font-bold text-sm text-green-700">{{ number_format($label->cost, 2) }} ر.س</div>
                    </div>
                </div>
                    ...
                    <div class="mt-4 bg-blue-50 rounded-lg p-3">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <span class="text-xs text-gray-500">| المبلغ: {{ number_format($label->order->grand_total, 2) }} ر.س</span>
                            </div>
    ...
    <form action="{{ route('admin.shipping.label.store') }}" method="POST" class="max-w-2xl">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 space-y-4">
            <div>
                ...
                <select name="order_id" class="w-full border rounded-lg px-4 py-2.5" required>
                    ...
                    @foreach($orders as $order)
                        <option value="{{ $order->id }}">#{{ $order->order_number }} - {{ number_format($order->grand_total, 2) }} ر.س</option>
                    @endforeach
                </select>
            </div>
            <div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">التكلفة (ر.س) *</label>

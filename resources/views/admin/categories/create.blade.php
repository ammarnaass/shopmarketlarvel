...
@section('content')
<div class="mb-6">
    <h1 class="text-3xl font-bold">إضافة تصنيف جديد</h1>
...
<form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data">
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-surface-container-lowest rounded-xl shadow-sm p-5">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-xs text-on-surface-variant mt-1">اتركه فارغاً لجعله تصنيف رئيسي</p>
        ...
        <div class="space-y-6">
            <div class="bg-surface-container-lowest rounded-xl shadow-sm p-5">
                ...
                <div class="mb-3">
                    ...
                    <p class="text-xs text-on-surface-variant mt-1">رقم أقل = يظهر أولاً</p>
            ...
            <div class="bg-surface-container-lowest rounded-xl shadow-sm p-5">
                ...
                <p class="text-xs text-on-surface-variant mt-1">JPEG, PNG, JPG — حد أقصى 2MB</p>
    ...
    <div class="mt-6 flex items-center gap-3">
        <button type="submit" class="bg-primary hover:bg-primary text-white px-6 py-2.5 rounded-lg font-semibold flex items-center gap-2">
            <span class="material-symbols-outlined">save</span>حفظ التصنيف
        </button>
